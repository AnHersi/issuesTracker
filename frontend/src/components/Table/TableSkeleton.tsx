...
const TableSkeleton: React.FunctionComponent = (props) => {
	return (
		<div
			role="status"
			className="w-full space-y-2 divide-y divide-gray-200 rounded shadow animate-pulse dark:divide-gray-700 md:p-6 dark:border-gray-700 transition-all duration-500 ease-in-out"
		>
